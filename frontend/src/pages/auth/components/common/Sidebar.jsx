...
const Sidebar = () => {
	const data = {
		fullName: "John Doe",
		username: "johndoe",
		profileImg: "/avatars/avatar1.png",
	};
	...
	return (
		<div className='md:flex-[2_2_0] w-18 max-w-52'>
			<div className='sticky top-0 left-0 h-screen flex flex-col border-r border-gray-700 w-20 md:w-full'>
                ...
                <img src="/public/logo.png" alt="Uconnect Logo" class='max-h-10 overflow-auto-'/>
				</Link>
					...
					>
						...
						<div className='flex justify-between flex-1'>
							<div className='hidden md:block'>
								<p className='text-black font-bold text-sm w-20 truncate'>{data?.fullName}</p>
